...
@observer
class FireZoneSetting extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            languages: [
                { label: langObj.fireZoneClosed, value: 0 },
                { label: langObj.fireZoneOpen, value: 1 }
            ],
            value1Index: 0,
            flagSettings: null
        };
                            ...
                            title={langObj.submit} onPress={() => {
                                NetInfo.fetch().then(state => {
                                    if (state.isConnected) {
                                        ...
                                        flagSettings.yanginZonTipi = this.state.value1Index;
...
export default FireZoneSetting;