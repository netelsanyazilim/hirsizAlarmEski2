...
@observer
class PasswordFreeArm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            languages: [
                { label: langObj.cantPasswordFreeArm, value: 0 },
                { label: langObj.canPasswordFreeArm, value: 1 }
            ],
            value1Index: 0,
            flagSettings: null
        };
                            ...
                            title={langObj.submit} onPress={() => {
                                NetInfo.fetch().then(state => {
                                    if (state.isConnected) {
                                        ...
                                        flagSettings.sifresizKurulum = this.state.value1Index;
...
export default PasswordFreeArm;