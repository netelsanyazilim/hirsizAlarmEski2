...
@observer
class EntryDelayTimer extends Component {
        ...
        NetInfo.fetch().then(state => {
            if (state.isConnected) {
                ApiCall.getSettings().then((x) => {
                    if (x) {
                        this.setState({
                            entryDelayTimer1: x.girisSuresi1,
                            entryDelayTimer2: x.girisSuresi2,
                            entryDelayTimer3: x.girisSuresi3,
                            entryDelayTimer4: x.girisSuresi4,
                            flagSettings: x
                        });
                        ...
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', marginLeft: 15, }}>
                                <Icon size={18} name="plus" color="gray" type="font-awesome"
                                    ...
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer1) + 1) < 256) {
                                            this.setState({ entryDelayTimer1: (Number.parseInt(this.state.entryDelayTimer1) + 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer1: "255" });
                                ...
                                <TextInput style={styles.textInput} textAlign={'center'} autoCapitalize={"none"} autoCorrect={false}
                                    value={this.state.entryDelayTimer1.toString()} onChangeText={(text) => {
                                        const parsedQty = Number.parseInt(text);
                                        if (!Number.isNaN(parsedQty) && text != "" && text != null) {
                                            if ((parsedQty < 256) && (parsedQty > 0)) {
                                                this.setState({ entryDelayTimer1: parsedQty.toString() });
                                            } else {
                                                this.setState({ entryDelayTimer1: "1" });
                                                Toast.show(langObj.minAndMaxValue, Toast.LONG);
                                            }
                                        } else {
                                            this.setState({ entryDelayTimer1: "" });
                                        }
                                    }}
                                ...
                                <Icon size={18} name="minus" type="font-awesome" color="gray"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer1) - 1) > 0) {
                                            this.setState({ entryDelayTimer1: (Number.parseInt(this.state.entryDelayTimer1) - 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer1: "1" });
                                ...
                                <Button borderRadius={4} buttonStyle={{ margin: 10, backgroundColor: "#cc1e18" }} title={langObj.submit}
                                    onPress={() => {
                                        NetInfo.fetch().then(state => {
                                            if (state.isConnected) {
                                                let flagSettings = {};
                                                flagSettings.girisSuresi1 = this.state.entryDelayTimer1;
                        ...
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', marginLeft: 15, }}>
                                <Icon size={18} name="plus" color="gray" type="font-awesome"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer2) + 1) < 256) {
                                            this.setState({ entryDelayTimer2: (Number.parseInt(this.state.entryDelayTimer2) + 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer2: "255" });
                                            Toast.show(langObj.maxValue, Toast.LONG);
                                        }
                                    }}
                                />
                                <TextInput style={styles.textInput} textAlign={'center'} autoCapitalize={"none"} autoCorrect={false}
                                    value={this.state.entryDelayTimer2.toString()} onChangeText={(text) => {
                                        const parsedQty = Number.parseInt(text);
                                        if (!Number.isNaN(parsedQty) && text != "" && text != null) {
                                            if ((parsedQty < 256) && (parsedQty > 0)) {
                                                this.setState({ entryDelayTimer2: parsedQty.toString() });
                                            } else {
                                                this.setState({ entryDelayTimer2: "1" });
                                                Toast.show(langObj.minAndMaxValue, Toast.LONG);
                                            }
                                        } else {
                                            this.setState({ entryDelayTimer2: "" });
                                        }
                                    }}
                                    maxLength={3} keyboardType={'numeric'} underlineColorAndroid={"black"} placeholderTextColor={"rgba(0,0,0,0.4)"}
                                    selectionColor={"black"}
                                ...
                                <Icon size={18} name="minus" type="font-awesome" color="gray"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer2) - 1) > 0) {
                                            this.setState({ entryDelayTimer2: (Number.parseInt(this.state.entryDelayTimer2) - 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer2: "1" });
                                            Toast.show(langObj.minValue, Toast.LONG);
                                    ...
                                    onPress={() => {
                                        NetInfo.fetch().then(state => {
                                            if (state.isConnected) {
                                                ...
                                                flagSettings.girisSuresi2 = this.state.entryDelayTimer2;
                                                flagSettings.girisSuresi3 = this.state.flagSettings.girisSuresi3;
                                                flagSettings.girisSuresi4 = this.state.flagSettings.girisSuresi4;
                                                flagSettings.cikisSuresi1 = this.state.flagSettings.cikisSuresi1;
                                                flagSettings.cikisSuresi2 = this.state.flagSettings.cikisSuresi2;
                        ...
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', marginLeft: 15, }}>
                                <Icon size={18} name="plus" color="gray" type="font-awesome"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer3) + 1) < 256) {
                                            this.setState({ entryDelayTimer3: (Number.parseInt(this.state.entryDelayTimer3) + 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer3: "255" });
                                            Toast.show(langObj.maxValue, Toast.LONG);
                                        }
                                    }}
                                />
                                <TextInput style={styles.textInput} textAlign={'center'} autoCapitalize={"none"} autoCorrect={false}
                                    value={this.state.entryDelayTimer3.toString()} onChangeText={(text) => {
                                        const parsedQty = Number.parseInt(text);
                                        if (!Number.isNaN(parsedQty) && text != "" && text != null) {
                                            if ((parsedQty < 256) && (parsedQty > 0)) {
                                                this.setState({ entryDelayTimer3: parsedQty.toString() });
                                            } else {
                                                this.setState({ entryDelayTimer3: "1" });
                                                Toast.show(langObj.minAndMaxValue, Toast.LONG);
                                            }
                                        } else {
                                            this.setState({ entryDelayTimer3: "" });
                                        }
                                    }}
                                    maxLength={3} keyboardType={'numeric'} underlineColorAndroid={"black"} placeholderTextColor={"rgba(0,0,0,0.4)"}
                                    selectionColor={"black"}
                                ...
                                <Icon size={18} name="minus" type="font-awesome" color="gray"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer3) - 1) > 0) {
                                            this.setState({ entryDelayTimer3: (Number.parseInt(this.state.entryDelayTimer3) - 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer3: "1" });
                                            Toast.show(langObj.minValue, Toast.LONG);
                                    ...
                                    onPress={() => {
                                        NetInfo.fetch().then(state => {
                                            if (state.isConnected) {
                                                ...
                                                flagSettings.girisSuresi1 = this.state.flagSettings.girisSuresi1;
                                                flagSettings.girisSuresi2 = this.state.flagSettings.girisSuresi2;
                                                flagSettings.girisSuresi3 = this.state.entryDelayTimer3;
                                                flagSettings.girisSuresi4 = this.state.flagSettings.girisSuresi4;
                                                flagSettings.cikisSuresi1 = this.state.flagSettings.cikisSuresi1;
                                                flagSettings.cikisSuresi2 = this.state.flagSettings.cikisSuresi2;
                                                flagSettings.cikisSuresi3 = this.state.flagSettings.cikisSuresi3;
                        ...
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', marginLeft: 15, }}>
                                <Icon size={18} name="plus" color="gray" type="font-awesome"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer4) + 1) < 256) {
                                            this.setState({ entryDelayTimer4: (Number.parseInt(this.state.entryDelayTimer4) + 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer4: "255" });
                                            Toast.show(langObj.maxValue, Toast.LONG);
                                        }
                                    }}
                                />
                                <TextInput style={styles.textInput} textAlign={'center'} autoCapitalize={"none"} autoCorrect={false}
                                    value={this.state.entryDelayTimer4.toString()} onChangeText={(text) => {
                                        const parsedQty = Number.parseInt(text);
                                        if (!Number.isNaN(parsedQty) && text != "" && text != null) {
                                            if ((parsedQty < 256) && (parsedQty > 0)) {
                                                this.setState({ entryDelayTimer4: parsedQty.toString() });
                                            } else {
                                                this.setState({ entryDelayTimer4: "1" });
                                                Toast.show(langObj.minAndMaxValue, Toast.LONG);
                                            }
                                        } else {
                                            this.setState({ entryDelayTimer4: "" });
                                        }
                                    }}
                                    maxLength={3} keyboardType={'numeric'} underlineColorAndroid={"black"} placeholderTextColor={"rgba(0,0,0,0.4)"}
                                    selectionColor={"black"}
                                ...
                                <Icon size={18} name="minus" type="font-awesome" color="gray"
                                    containerStyle={Platform.OS === 'ios' ? { marginTop: 10 } : { marginTop: 20 }}
                                    onPress={() => {
                                        if ((Number.parseInt(this.state.entryDelayTimer4) - 1) > 0) {
                                            this.setState({ entryDelayTimer4: (Number.parseInt(this.state.entryDelayTimer4) - 1).toString() });
                                        } else {
                                            this.setState({ entryDelayTimer4: "1" });
                                            Toast.show(langObj.minValue, Toast.LONG);
                                    ...
                                    onPress={() => {
                                        NetInfo.fetch().then(state => {
                                            if (state.isConnected) {
                                                ...
                                                flagSettings.girisSuresi2 = this.state.flagSettings.girisSuresi2;
                                                flagSettings.girisSuresi3 = this.state.flagSettings.girisSuresi3;
                                                flagSettings.girisSuresi4 = this.state.entryDelayTimer4;
                                                flagSettings.cikisSuresi1 = this.state.flagSettings.cikisSuresi1;
                                                flagSettings.cikisSuresi2 = this.state.flagSettings.cikisSuresi2;
                                                flagSettings.cikisSuresi3 = this.state.flagSettings.cikisSuresi3;
                                                flagSettings.cikisSuresi4 = this.state.flagSettings.cikisSuresi4;
...
export default EntryDelayTimer;