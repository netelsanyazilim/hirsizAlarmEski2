...
@observer
class CentralBuzzerSetting extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            languages: [
                { label: langObj.soundClose, value: 0 },
                { label: langObj.soundOpen, value: 1 }
            ],
            value1Index: 0,
            flagSettings: null
        };
                            ...
                            title={langObj.submit} onPress={() => {
                                NetInfo.fetch().then(state => {
                                    if (state.isConnected) {
                                        ...
                                        flagSettings.santralBuzzer = this.state.value1Index;
...
export default CentralBuzzerSetting;