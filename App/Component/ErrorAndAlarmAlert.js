...
class DisarmAlert extends Component {
    ...
    renderError() {
        ...
        { logo: "plug", type: 'font-awesome' }, { logo: "battery-quarter", type: 'font-awesome' }, { logo: "battery-alert", type: 'material-community' }];
        let errorText = [langObj.faultSiren, langObj.alarmPanic, langObj.faultElectricity, langObj.faultBattery, langObj.noBattery];
                    ...
                    <View key={index} style={{ width: '100%' }} >
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', width: '100%' }} >
                            <Icon
                                ...
                                size={26}
                            />
                            <Text style={{ justifyContent: 'center', alignSelf: 'center' }} >{errorText[index]}</Text>
                        </View>
